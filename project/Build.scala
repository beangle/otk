...
object OtkDepends {
  val beangle_commons = "org.beangle.commons" % "beangle-commons" % "5.6.30-SNAPSHOT"
  ...
  val beangle_doc_transfer = "org.beangle.doc" % "beangle-doc-transfer" % "0.4.15-SNAPSHOT"
  val beangle_doc_pdf = "org.beangle.doc" % "beangle-doc-pdf" % "0.4.15-SNAPSHOT"
  val beangle_doc_excel = "org.beangle.doc" % "beangle-doc-excel" % "0.4.15-SNAPSHOT"
}
