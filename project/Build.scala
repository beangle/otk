...
object OtkDepends {
  val b_commons = "org.beangle.commons" % "beangle-commons" % "5.6.28"
  val b_jdbc = "org.beangle.jdbc" % "beangle-jdbc" % "1.0.11"
  val b_model = "org.beangle.data" % "beangle-model" % "5.8.23"
  ...
  val b_security = "org.beangle.security" % "beangle-security" % "4.3.28"
  val b_ids = "org.beangle.ids" % "beangle-ids" % "0.3.24"
  val b_event = "org.beangle.event" % "beangle-event" % "0.1.0"
  val b_doc_transfer = "org.beangle.doc" % "beangle-doc-transfer" % "0.4.12"
  val b_doc_pdf = "org.beangle.doc" % "beangle-doc-pdf" % "0.4.12"
}
